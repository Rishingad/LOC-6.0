    ...
    return (
        <nav className="navbar">
            ...
            <ul className={`nav-menu ${isMenuOpen ? 'menu-show' : ''}`} >
                ...
                {
                    !isMenuOpen ? null : <CloseIcon onClick={menuHandler} fontSize="large" color="primary" ></CloseIcon>
                }
            </ul>
            {
                !isMenuOpen ? <MenuIcon onClick={menuHandler} fontSize="large"  ></MenuIcon> : null
            }
        </nav>
    );
